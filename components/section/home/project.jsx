      ...
      <motion.section className="bg-accent py-24 sm:py-10"  >
        ...
        <div className="container relative">
          <div className="flex flex-wrap justify-between">
              ...
              <div className="flex flex-col items-start justify-start gap-3 bg-transparent lg:items-start lg:justify-start lg:gap-0 md:flex-row md:gap-x-3 sm:flex-row sm:justify-center">
                {["ongoing", "upcoming", "complete"].map((item, index) => (
                  <Button
                    ...
                    className={`bg-transparent px-0 py-0 text-left font-saol text-4xl font-normal capitalize hover:bg-transparent lg:text-sm md:text-sm sm:text-sm ${isActive == item
            ...
            <div className="w-9/12  relative max-w-[956px] px-0 py-0 lg:w-10/12 md:w-full sm:w-full">
              <div className="mt-0 h-full">
                <Carousel className=" h-full relative w-full">
